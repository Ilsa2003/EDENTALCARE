<footer class="w3l-footer-66">
				...
				<div class="row footer-top">
					<div class="col-lg-4 footer-grid_section_w3layouts pr-lg-5">
						<h2 class="logo-2 mb-lg-4 mb-3">
							<a class="navbar-brand" href="index.php"><span>E-</span>Dental</a>
							<!-- if logo is image enable this   
									<a class="navbar-brand" href="#index.php">
										<img src="image-path" alt="Your logo" title="Your logo" style="height:35px;" />
									</a> -->
						</h2>
						<p>E-dental is a website which meets all the requirements of a dental clinic and to help the dentist in managing their clinics in an effective manner.</p>
		...
		<div class="cpy-right py-3">
			<p class="text-center">© 2020 Edental. All rights reserved | Design by 
				<a href="" target="_blank">Edental</a>
			</p>
		</div>
		<!-- move top -->
