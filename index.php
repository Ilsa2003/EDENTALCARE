		...
		<div class="content-6-mian py-5">
			<div class="container py-lg-5">
				<div class="title-content text-left mb-4">
					...
					<h3 class="hny-title">Welcome to E-dental</h3>
				</div>
				<div class="content-info-in row">
					<div class="content-gd col-lg-6 pl-lg-4">
						<p>At Edental clinic, we provide our patients with all the information they need regarding their oral health, helping them make the right decision about their dental care and achieving the most desirable outcome.We aim at providing care for our patients as we would wish to be cared for ourselves.</p>
					</div>
					<div class="content-gd col-lg-6 pl-lg-4 pl-lg-4">
						<p>Our dental clinic is well prepared with latest technology and equipments, offering best quality treatment with objective to keep infection free working environment. Our dentists are committed to cure your oral health concerns. We understand what you want and our dentist work together with you to ensure your smile will always be the pretty.</p>
					</div>
				</div>
		</div>
	</section>
