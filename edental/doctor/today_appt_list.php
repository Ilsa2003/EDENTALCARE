...
$sql="SELECT * FROM appointment,patient where patient.p_id=appointment.patient_id and d_id='$did' and b_date='$now1'";
         ...
         while($row=$result->fetch_assoc())
         {
            ...
            <tr>
               ...
               <td>
                ...
                {
                ?>
                 <a href="common.php?aapid=<?php echo $row['appointment_id'];?>"> View </a>|
