...
if(isset($_POST['add_precipitation']))    
{
     $p_id=$_POST['p_id'];
     $a_id=$_POST['a_id'];
    $did=$_SESSION['did'];
...
<html>
<head>
<title>E-dental | Add Precipitation</title>
		  ...
		  <div class="tab-content">
            <div class="tab-pane active" id="horizontal-form">
                <form action="" method="POST" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <input type="submit" name="add_precipitation" value="Add Precipitation" class="btn-success btn">
                        </div>
                    </div>
                </form>
            </div>
