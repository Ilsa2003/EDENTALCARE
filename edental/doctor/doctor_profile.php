...
$did=$_SESSION['did'];
$sql="select * from doctor_info,deg where deg.deg_id=doctor_info.d_degree and  d_id='$did'";
...
<html>
<head>
<title>E-dental | Doctor Profile</title>
                ...
                <div class=" col-md-9 col-lg-9 "> 
                  <table class="table table-user-information">
                    <tbody>
                      ...
                      <tr>
                        <td>Degree / Reg No:</td>
                        <td><?php echo $row['deg_name'];?> / <?php echo $row['d_reg_no'];?></td>
                      </tr>
                      <tr>
                        <td>Status</td>
