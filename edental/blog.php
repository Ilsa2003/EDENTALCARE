...
<body>
	...
	<nav id="breadcrumbs" class="breadcrumbs">
		<div class="container page-wrapper">
			<a href="index.php">Home</a> » <span class="breadcrumb_last" aria-current="page">Blog</span>
		</div>
	</nav>
	<!-- //breadcrumbs -->
	<!-- services block 2 -->
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6 service_grid_btm_left mt-lg-5 mt-4">
						<div class="service_grid_btm_left1">
							...
							?>
								<img src="<?php echo $row['blog_pic'];?>" alt=" " class="img-fluid" />
							<?php 
							}
							if($row['blog_type']=='2')
							{
  ...
  <source src="<?php echo $row['blog_pic'];?>" type="video/mp4"></video>
						<?php } ?>
							</a>
