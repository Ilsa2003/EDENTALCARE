...
if(isset($_POST['chan_pwd']))
{
    ...
    $n_pwd=$_POST['n_pwd'];
    $nc_pwd=$_POST['nc_pwd'];
$sql="select * from admin where a_pwd='$c_pwd' and a_email='$aemail'";
$result=$conn->query($sql);
...
if($n_pwd==$nc_pwd)
{
$sql="UPDATE `admin` SET `a_pwd`='$n_pwd' WHERE a_email='$aemail'";
...
<html>
<head>
<title>E-dental | Admin Setting</title>
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
          ...
          <div class="panel panel-info">
            <div class="panel-heading">
              <h3 class="panel-title"><?php echo $row['a_name'];?></h3>
            </div>
