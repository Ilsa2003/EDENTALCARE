...
{
$target_dir="../eblog/";
$img_path="eblog/".basename($_FILES["spic"]["name"]);
...
if ($uploadOk==0)
{
  header('Location:add_service.php?msg=Error in File Uploading');
}
else
{
  if(move_uploaded_file($_FILES["spic"]["tmp_name"], $target_file))
{
  $b=$_POST['sname'];
  $c=$_POST['sprc'];
  $sql= "INSERT into service(service_pic,service_offer,price) VALUES ('$img_path','$b','$c')";
  if ($conn->query($sql) === TRUE) 
  {
    header('Location:service_list.php?msg=Serivce Added Successfully..');
         // echo "Data insert";
  }
  else
  {
    header('Location:service_list.php?msg=Error in Adding Service..');
  }
}
    else
    {
...
<html>
<head>
<title>E-dental | Add Service</title>
            ...
            <div class="tab-pane active" id="horizontal-form">
              <form action="" method="POST" class="form-horizontal" enctype="multipart/form-data">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control1" id="focusedinput" name="sname" placeholder="Name Of Service" required="">
                  </div>
                </div> 
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control1" id="focusedinput" name="sprc" placeholder="Price of service" required="">
                  </div>
                </div>                    
                <div class="form-group">
                  <div class="col-sm-8 col-sm-offset-2">
                        <!-- <button class="btn-success btn">Submit</button> -->
                        <input type="submit" name="add_ser" value="Add Service" class="btn-success btn" required="">
                      </div>
                  </div>
                </div> 
