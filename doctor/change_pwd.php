...
$did=$_SESSION['did'];
$sql="select * from doctor_info where d_id='$did'";
...
$did=$_SESSION['did'];
    ...
    $n_pwd=$_POST['n_pwd'];
    $nc_pwd=$_POST['nc_pwd'];
$sql="select * from doctor_info where password='$c_pwd' and d_id='$did'";
$result=$conn->query($sql);
...
if($n_pwd==$nc_pwd)
{
$sql="UPDATE `doctor_info` SET `password`='$n_pwd' WHERE d_id='$did'";
...
<html>
<head>
<title>E-dental | Doctor Setting</title>
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
          ...
          <div class="panel panel-info">
            <div class="panel-heading">
              <h3 class="panel-title"><?php echo $row['d_name'];?></h3>
            </div>
            <div class="panel-body">
              <div class="row">
                <div class="col-md-3 col-lg-3 " align="center"> <img alt="User Pic" src="../<?php echo $row['d_pic'];?>" class="img-circle img-responsive"> </div>
